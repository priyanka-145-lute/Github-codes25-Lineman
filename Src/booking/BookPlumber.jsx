...
const products = [
  {
    ...
    price: '839',
    image: require('../assets/Plumber1.png'),
  },
  {
    id: '2',
    title: ' Washing Machine Pipe',
    stock: true,
    description:'Semi-Automatic Washing Machine Pipe Inlet 2 Meters',
    price: '169',
  ...
  },
  {
    ...
    price: '299',
    image: require('../assets/Plumber3.png'),
  },
  {
    id: '4',
    title: 'Tap',
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.searchBar}>
        ...
        />
        <TextInput
          placeholder="Search for Tap,Water tank cleaning"
