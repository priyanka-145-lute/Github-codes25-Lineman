...
const products = [
  {
    ...
    title: 'Switches',
    stock: true,
    description: 'Anchor Roma Classic White 1 Way 10 A Modular Switch',
    price: '158',
    image: require('../assets/Electrician1.png'),
  },
  {
    id: '2',
    title: 'HDMI cable',
    stock: true,
    description:
      'ebronics - (3 Meter) Channels,Compatible With Hdmi-Enabled Devices Like Tvs, Computers, Playstation, Black',
    price: '1200',
    image: require('../assets/Electrician3.png'),
  },
  {
    id: '3',
    title: 'Fan Regulator',
    stock: true,
    description: 'OvCart 7 Step Ceiling Fan Regulator, 2 Piece, White',
    price: '399',
    image: require('../assets/Electrician2.png'),
  },
  {
    id: '4',
    title: 'Bulb',
